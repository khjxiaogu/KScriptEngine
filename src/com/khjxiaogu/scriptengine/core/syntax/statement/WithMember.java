...
public class WithMember extends SingleOperator implements  Assignable {
	...
	public KVariantReference evalAsRef(KEnvironment env) throws KSException {
		...
		return new KEnvironmentReference(((WithEnvironment) env).getWith(),((LiteralNode) super.Child).getToken()).withFlag(KEnvironment.THISONLY);
	}
