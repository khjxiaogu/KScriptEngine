...
public class TypeConverter<From, To> {
	...
	/**
	 * Instantiates a new type converter with a input type,output type and a conversion function.<br />
	 * 使用输入类型、输出类型和转换函数来新建一个类型转换器<br />
	 *
	 * @param from from type<br />输入类型
	 * @param to   to type<br />输出类型
	 * @param func conversion function<br />转换函数
	 */
