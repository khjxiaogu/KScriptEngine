...
public class Converter {
	 ...
	 * 使用一个类型新建一个转换器类<br />
	 *
	 * @param type the output type<br />输出类型
	 */
	...
	/**
	 * Gets the conversion of from type to output type, return null if not found<br />
	 * 获取由from type转换为输出类型的转换器，如果没有这种转换，返回null
	 *
	 * @param fromType the from type<br />输入类型
	 * @return converter of specific type<br />对应类型的转换器
	 */
	 ...
	 * 获取输出类型信息.
	 *
	 * @return output type info<br />输出类型信息
	 */
	 ...
	 * 获取输出类型名.
	 *
	 * @return output type name<br />输出类型名
	 */
	 ...
	 *
	 * @param fromType  the from type<br />输入类型
	 * @param converter the converter<br />转换器
	 */
